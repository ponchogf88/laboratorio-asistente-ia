# Fase 1B - Automatización de Google Classroom (pospuesta)

> Esta guía no aplica al piloto actual. El acceso se entrega manualmente por WhatsApp tras validar la transferencia; no actives n8n, Google Cloud ni OAuth todavía.
